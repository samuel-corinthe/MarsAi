  ...
  resources: {
    fr: {
      translation: {
        ...
        upload: {
          title: "Concours MarsAI 2026",
          subtitle: "Partagez votre vision d'un futur souhaitable.",
          form: {
            email_label: "Votre Email",
            email_placeholder: "votre@email.com",
            email_hint: "Nous vous contacterons à cette adresse",
            firstname_label: "Votre Prénom",
            lastname_label: "Votre Nom",
            age_label: "Votre Âge",
            age_hint: "Vous devez avoir au moins 18 ans pour participer",
            video_label: "Fichier vidéo (MP4 uniquement)",
            video_button: "Choisir une vidéo",
            video_requirements:
              "Taille max : 300Mo • Format : 16:9 obligatoire • Durée : 45-100 secondes",
            required: "requis",
          },
          button: {
            submit: "Soumettre ma participation",
            uploading: "Traitement en cours...",
            validating: "Analyse de la vidéo...",
          },
          errors: {
            format: "Seul le format MP4 est accepté.",
            file_missing: "Veuillez sélectionner une vidéo",
            altcha: "Veuillez compléter la vérification anti-robot",
            generic: "Une erreur est survenue lors de l'upload.",
          },
          status: {
            success: "Votre vidéo a été mise en ligne avec succès !",
            validated: "Vidéo validée ! Prête pour l'envoi.",
          },
        },
      },
    },
