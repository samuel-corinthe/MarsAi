...
const extraTranslations = {
  fr: {
    ...
    movie_details: {
      ...
      admin_youtube_eyebrow: "الرابط العام",
      admin_youtube_current: "الرابط الحالي",
      admin_youtube_empty: "لا يوجد رابط YouTube محفوظ لهذا الفيلم.",
      admin_youtube_field: "رابط YouTube جديد",
      admin_youtube_save: "حفظ الرابط",
      admin_youtube_saving: "جارٍ الحفظ...",
      admin_youtube_reset: "إعادة الضبط",
      admin_youtube_invalid: "ألصق رابط YouTube صالحًا (watch أو youtu.be أو embed أو shorts أو معرّف فيديو).",
      admin_youtube_saved: "تم تحديث رابط YouTube لهذا الفيلم.",
      admin_youtube_already_current: "رابط YouTube محدّث بالفعل.",
      admin_youtube_save_error: "تعذّر تحديث رابط YouTube.",
      contact_email_body: "Bonjour,\n\nJe vous contacte au sujet du film \"{{title}}\".\n\n",
      admin_youtube_eyebrow: "Lien public",
      admin_youtube_current: "Lien actuel",
      admin_youtube_empty: "Aucun lien YouTube n est enregistre pour ce film.",
      admin_youtube_field: "Nouveau lien YouTube",
      admin_youtube_save: "Enregistrer le lien",
      admin_youtube_saving: "Enregistrement...",
      admin_youtube_reset: "Reinitialiser",
      admin_youtube_open: "Ouvrir le lien",
      admin_youtube_invalid: "Collez un lien YouTube valide (watch, youtu.be, embed, shorts ou identifiant video).",
      admin_youtube_saved: "Lien YouTube mis a jour pour ce film.",
      admin_youtube_already_current: "Le lien YouTube est deja a jour.",
      admin_youtube_save_error: "Impossible de mettre a jour le lien YouTube.",
    },
    contact: {
      form: {
  ...
  en: {
    ...
    movie_details: {
      ...
      admin_youtube_eyebrow: "Public link",
      admin_youtube_current: "Current link",
      admin_youtube_empty: "No YouTube link is currently saved for this film.",
      admin_youtube_field: "New YouTube link",
      admin_youtube_save: "Save link",
      admin_youtube_saving: "Saving...",
      admin_youtube_reset: "Reset",
      admin_youtube_open: "Open link",
      admin_youtube_invalid: "Paste a valid YouTube link (watch, youtu.be, embed, shorts, or a video ID).",
      admin_youtube_saved: "YouTube link updated for this film.",
      admin_youtube_already_current: "The YouTube link is already up to date.",
      admin_youtube_save_error: "Unable to update the YouTube link.",
    },
    contact: {
      form: {
