  ...
  resources: {
    ...
    ar: {
      translation: {
        ...
        newsletter: {
          hero: {
            badge: "نشرة MarsAI الإخبارية",
            title_main: "ابق على",
            title_accent: "اطلاع",
            description:
              "احصل على آخر الأخبار، الأفلام المختارة، وعروض المهرجان الحصرية مباشرة في بريدك الإلكتروني.",
          },
          form: {
            title: "اشترك الآن",
            subtitle: "مجاني • بدون إزعاج • إلغاء اشتراك سهل",
            label_name: "الاسم الأول",
            placeholder_name: "اسمك الأول",
            label_email: "البريد الإلكتروني",
            placeholder_email: "your@email.com",
            submit: "اشترك في النشرة",
            loading: "جاري الاشتراك...",
            rgpd: "بالتسجيل، فإنك توافق على تلقي رسائل من مهرجان MarsAI. يمكنك إلغاء الاشتراك في أي وقت.",
            success_title: "تم تأكيد الاشتراك!",
            success_msg:
              "مرحباً بك في مجتمع MarsAI! ستتلقى أول نشرة إخبارية قريباً.",
          },
          benefits: {
            title: "لماذا تشترك؟",
            subtitle: "مزايا حصرية لمشتركينا",
            preview: {
              title: "كن أول من يعلم",
              desc: "ابق في الطليعة مع الإعلانات الرسمية والاختيارات",
            },
          },
          faq: {
            title: "الأسئلة الشائعة",
            q1: "كم مرة سأتلقى النشرة؟",
            a1: "نرسل نشرتين شهرياً: واحدة في بداية الشهر للأخبار، وواحدة في منتصفه لمحتوى حصري.",
            q2: "هل يمكنني إلغاء الاشتراك؟",
            a2: "نعم، بالتأكيد. كل رسالة تحتوي على رابط لإلغاء الاشتراك في الأسفل.",
          },
        },
      },
    },
