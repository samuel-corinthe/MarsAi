    ...
    <>
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="text-center space-y-6">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white leading-tight" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
              Restez dans<br />
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed" style={{ fontFamily: "'Inter', sans-serif" }}>
          ...
          <div className="grid grid-cols-3 gap-4 md:gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center space-y-2">
                <div className="text-3xl md:text-5xl font-black text-transparent bg-gradient-to-r from-cyan-400 to-pink-500 bg-clip-text" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
                  {stat.number}
                </div>
                <div className="text-gray-400 text-xs md:text-base" style={{ fontFamily: "'Inter', sans-serif" }}>
                  {stat.label}
                </div>
              </div>
            ))}
          ...
          {!isSubmitted ? (
            <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-3xl p-6 md:p-12 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="firstName" className="block text-sm font-medium text-gray-300 mb-2" style={{ fontFamily: "'Inter', sans-serif" }}>
                    Prénom
                  </label>
                  <input type="text" id="firstName" name="firstName" value={formData.firstName} onChange={handleInputChange} required
                    ...
                    placeholder="Votre prénom" style={{ fontFamily: "'Inter', sans-serif" }} />
                </div>
                ...
                <div>
                  ...
                  <input type="email" id="email" name="email" value={formData.email} onChange={handleInputChange} required
                    className="w-full px-4 py-3 bg-gray-900 border border-gray-800 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-400/50 focus:border-cyan-400 transition-all duration-200"
                    placeholder="votre@email.com" style={{ fontFamily: "'Inter', sans-serif" }} />
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {contentPreferences.map((pref) => (
                      <label key={pref.id} className="flex items-center space-x-3 cursor-pointer group">
                        <input type="checkbox" checked={formData.preferences.includes(pref.id)} onChange={() => handleCheckboxChange(pref.id)}
                        ...
                        <span className="text-gray-400 group-hover:text-gray-300 transition-colors" style={{ fontFamily: "'Inter', sans-serif" }}>
                          {pref.label}
                        </span>
                      </label>
                    ))}
                ...
                <p className="text-xs text-gray-500 leading-relaxed" style={{ fontFamily: "'Inter', sans-serif" }}>
                  En vous inscrivant, vous acceptez de recevoir des emails de marsAI Festival. Vous pouvez vous désabonner à tout moment.
            ...
            <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/30 rounded-3xl p-6 md:p-12 text-center animate-fadeIn">
              ...
              <h3 className="text-3xl md:text-4xl font-black text-white mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
                Inscription confirmée !
              </h3>
              <p className="text-lg text-gray-300 mb-6" style={{ fontFamily: "'Inter', sans-serif" }}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="group p-6 md:p-8 bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl hover:border-cyan-400/50 transition-all duration-300">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-white mb-3" style={{ fontFamily: "'Inter', sans-serif" }}>
                  {benefit.title}
                </h3>
                <p className="text-gray-400 leading-relaxed text-sm md:text-base" style={{ fontFamily: "'Inter', sans-serif" }}>
                  {benefit.description}
                </p>
              </div>
            ))}
      ...
      <section className="py-20 px-4">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-black text-white text-center mb-12" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
